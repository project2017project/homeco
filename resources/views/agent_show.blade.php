...
@section('frontend-content')
    ...
    <!-- End breadcrumbs -->
     ...
     <!-- Agents -->
		<section class="agent-parent-main-wrapper pd-top-40 pd-btm-70">
			<div class="container">
				<div class="row">
						...
						<div class="homec-property-bar">
							...
							<div class="homec-property-bar__single">
								<div id="homec-tabs" class="list-group homec-gl-tabs" role="tablist">
									...
									<a class="list-group-item active" data-bs-toggle="list" href="#homec-list" role="tab">
                                    ...
                                    <a class="list-group-item" data-bs-toggle="list" href="#homec-grid" role="tab">
