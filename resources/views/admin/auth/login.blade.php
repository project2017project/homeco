                ...
                <form class="needs-validation" novalidate="" id="adminLoginForm">
                  ...
                  <div class="form-group">
                    ...
                    @if (env('APP_MODE') == 'DEMO')
                       <input id="email exampleInputEmail" type="email" class="form-control" name="email" value="admin@gmail.com" tabindex="1" autofocus value="{{ old('email') }}">
                    @else
                  ...
                  <div class="form-group">
                    ...
                    @if (env('APP_MODE') == 'DEMO')
                      <input id="password exampleInputPassword" type="password" class="form-control" name="password" value="1234" tabindex="2">
                    @else
