...
@section('frontend-content')
    ...
    <section class="homec-contact-form homec-bg-cover pd-top-80 pd-btm-60">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="contact-side-pic">
                        <img src="{{ asset($contact->supporter_image) }}" alt="Contact Image">
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Contact Area -->
    <section class="contact contact-info-wrapper pd-top-40 pd-btm-100">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-12">
                    <!-- Single Contact -->
                    <div class="homec-contact__single mg-btm-20">
